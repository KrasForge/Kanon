...
| BOM | JSON/CSV import, missing MPN/duplicate/conflict checks, public JLCSearch lookup, sourcing risk | Account-gated official supplier API, qualification of real alternate parts |
...
| Manufacturing | Profile/schema rules, native stackup/BOM parity, two-phase manifests, artifact approval, real optional STEP collision and Gerber/PCB rendering | Actual fabrication capability qualification and live FreeCAD |
