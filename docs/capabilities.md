...
| Manufacturing | Profile/schema rules, native stackup/BOM parity, two-phase manifests and artifact approval | Actual fabrication capability qualification and live FreeCAD |
